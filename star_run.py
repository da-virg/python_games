...
def draw():
    global stars,game_over, current_level, game_over, game_complete
    screen.clear()
    screen.blit("space", (0, 0))
    if game_over:
        diplay_mesage("GAME OVER!", "try again.")
    elif game_complete:
        diplay_mesage("you won!", "well done.")
    else:
        for star in stars:
            star.draw()
...
def diplay_mesage(heading_text, sub_heading_text):
